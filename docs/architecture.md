...
## Main Components
- `apps/backend/app/routes/`: API endpoints (`chat`, `RAG chat`, `upload`)
- `apps/backend/app/services/`: LLM service (Google Gemini integration)
- `apps/backend/app/rag/`: RAG pipeline modules:
...
- `apps/backend/chroma_db/`: ChromaDB persistent data
